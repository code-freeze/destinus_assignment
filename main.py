...
f_totals = [3000,3200,3400,3600,3800,4000,4200,4400,4600,4800,5000,5200,5400,5600,5800,6000,6200,6400]
vis=0.5  # Viscosity of the material model (per second)
...
for f_total in f_totals:
    ...
    our_element = Element(number_elements, 10,50, 20, 100, weight)
    ...
    plt.savefig(str(f_total)+'.png', dpi=300, bbox_inches='tight')
